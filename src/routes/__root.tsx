  ...
  head: () => ({
    meta: [
      ...
      { title: "Pathly — Australian opportunities, mapped around you" },
      {
        name: "description",
        content:
          "Pathly maps Australian jobs around you, scores how well you match, and shows exactly what to learn to unlock more.",
      },
      { name: "author", content: "Pathly" },
      { property: "og:title", content: "Pathly — Your career, mapped." },
      {
        property: "og:description",
        content: "Australian opportunities, mapped around you.",
      },
